              ...
              <form id="addProject">
                ...
                <div class="form-group">
                    ...
                    <select name="project_customer_id" class="form-control" id="">
                      <?php 
                        foreach($data['customers'] as $customer){
                          ?>
                            <option value="<?=$customer->customer_id?>"><?=$customer->customer_name." ".$customer->customer_surname?></option>
                          <?php
                        }
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="project_title" name="project_title" placeholder="Proje Başlığı">
                  </div>
                  <div class="form-group">
                    <label for="project_detail">Proje Detayları</label>
                    <textarea rows="3" cols="30"  class="form-control" id="project_detail" name="project_detail" placehol der="Proje Detay Bilgileri"></textarea>
             
                  </div>
                  <div class="form-group">
                    <label for="project_start_date">Başlangıç Tarihi</label>
                    <input type="date" class="form-control" id="project_start_date" name="project_start_date" placeholder="Firma Adı">
                  </div>
                  <div class="form-group">
                    <label for="project_end_date">Bitiş Tarihi</label>
                    <input type="date" class="form-control" id="project_end_date" name="project_end_date" placeholder="Firma Adı">
                  </div>
                  <div class="form-group">
                    <label for="project_progress">İlerleyiş</label>
                    <input type="range" class="form-control" min="0" max="100" id="project_progress" name="project_progress" placeholder="Telefon">
                  </div>
                  <div class="form-group">
...
<script>
    ...
    form.addEventListener("submit",function(e){
        ...
        axios.post("<?=requestLink("project/add")?>",formData)
        .then(res=>{
